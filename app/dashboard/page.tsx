  ...
  return (
    <div data-testid="dashboard-page" className="max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <h1 data-testid="dashboard-welcome" className="text-2xl font-bold" style={{ color: 'var(--text-primary)', fontFamily: 'var(--font-display)' }}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <a data-testid="nav-projects" href="/dashboard/projects"
        ...
        <a data-testid="nav-users" href="/dashboard/users"
